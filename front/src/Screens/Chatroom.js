        ...
        return (
            <div>
                                ...
                                {(this.state.editMsgBox === message._id) ?
                                    ...
                                    <div style={{ marginLeft: "auto" }}>
                                        {message.sender.username === this.props.user.userName &&
                                            <button className="edit-btn" onClick={() => { this.setState({ editMsgBox: message._id }) }}> edit </button>}
                                    </div>
                                }
                            </div>
                        </div>
                ...
                <div className="chat-div">
                    <div>
                        <input className="chat-box" type="text" value={this.state.message} onChange={this.handleMessageChange}/>
                        ...
                        {isCreator ? (<button className="msg-button" onClick={this.handleDeleteRoom}>Delete Room</button>)
